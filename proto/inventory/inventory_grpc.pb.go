...
const (
	...
	InventoryService_DeleteProductByID_FullMethodName = "/inventory.InventoryService/DeleteProductByID"
...
type InventoryServiceClient interface {
	...
	DeleteProductByID(ctx context.Context, in *ProductID, opts ...grpc.CallOption) (*DeleteResponse, error)
	ListProducts(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ProductList, error)
	DecreaseStock(ctx context.Context, in *DecreaseStockRequest, opts ...grpc.CallOption) (*ProductResponse, error)
}
...
func (c *inventoryServiceClient) DeleteProductByID(ctx context.Context, in *ProductID, opts ...grpc.CallOption) (*DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteResponse)
	err := c.cc.Invoke(ctx, InventoryService_DeleteProductByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *inventoryServiceClient) DecreaseStock(ctx context.Context, in *DecreaseStockRequest, opts ...grpc.CallOption) (*ProductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductResponse)
...
type InventoryServiceServer interface {
	...
	DeleteProductByID(context.Context, *ProductID) (*DeleteResponse, error)
	ListProducts(context.Context, *Empty) (*ProductList, error)
	DecreaseStock(context.Context, *DecreaseStockRequest) (*ProductResponse, error)
...
func (UnimplementedInventoryServiceServer) DeleteProductByID(context.Context, *ProductID) (*DeleteResponse, error) {
...
func (UnimplementedInventoryServiceServer) DecreaseStock(context.Context, *DecreaseStockRequest) (*ProductResponse, error) {
...
func _InventoryService_DeleteProductByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProductID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServiceServer).DeleteProductByID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InventoryService_DeleteProductByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).DeleteProductByID(ctx, req.(*ProductID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _InventoryService_DeleteProductByID_Handler,
		},
		{
